...
#define STRING_CONFIG_H_AUTHOR "matt.cross@gmail.com" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -46, -10, -2.25 }
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + 28 // Allow a bit of overrun on X to probe more
